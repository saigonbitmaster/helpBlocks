...
const Menu = ({ dense = false }: MenuProps) => {
  ...
  return (
    ...
    >
      ...
      <SubMenu
        handleToggle={() => handleToggle("cases")}
        isOpen={state.cases}
        name="pos.menu.cases"
      ...
      >
        <MenuItemLink
          ...
          primaryText={translate(`resources.caseList.name`, {
            smart_count: 2,
          })}
      ...
      <SubMenu
        handleToggle={() => handleToggle("votes")}
        isOpen={state.votes}
        name="pos.menu.votes"
      ...
      >
        <MenuItemLink
          to="/casevote"
          state={{ _scrollToTop: true }}
          primaryText={translate(`resources.caseVotes.name`, {
            smart_count: 2,
          })}
          leftIcon={<ThumbUpOffAltOutlinedIcon />}
          dense={dense}
        />
        <MenuItemLink
          to="/unlockvote"
          state={{ _scrollToTop: true }}
          primaryText={translate(`resources.unlockVotes.name`, {
            smart_count: 2,
          })}
          leftIcon={<ThumbUpOffAltOutlinedIcon />}
          dense={dense}
      ...
      >
        <MenuItemLink
          to="/postedcasereport"
          state={{ _scrollToTop: true }}
          primaryText={translate(`resources.caseReports.name`, {
            smart_count: 2,
          })}
          leftIcon={<NotesIcon />}
          dense={dense}
        ...
        <MenuItemLink
          to="/votereports"
          state={{ _scrollToTop: true }}
          primaryText={translate(`resources.voteReports.name`, {
            smart_count: 2,
          })}
          leftIcon={<ThumbUpOffAltOutlinedIcon />}
          dense={dense}
